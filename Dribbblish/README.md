...
There are 15 color schemes you can choose: `base`, `white`, `dark`, `dracula`, `nord-light`, `nord-dark`, `purple`, `samurai`, `beach-sunset`, `gruvbox`, `rosepine`, `catppuccin-latte`, `catppuccin-frappe`, `catppuccin-macchiato`, and `catppuccin-mocha`. Change scheme with commands:
```
